...
- `legal-review-agent_safe.eide` — the correct design.
- `legal-review-agent_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
